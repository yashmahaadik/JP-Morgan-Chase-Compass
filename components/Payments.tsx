    ...
    <div className="p-4 md:p-8 pt-6 h-full bg-compass-bg pb-32 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-6">
                     ...
                     <div className="grid grid-cols-4 gap-4">
                          {[
                              ...
                              <div key={i} className="flex flex-col items-center gap-2 cursor-pointer group">
                                   ...
                                   <span className="text-[10px] text-center font-medium text-compass-muted group-hover:text-white leading-tight max-w-[70px]">{action.label}</span>
                              </div>
                          ))}
                     </div>
                     ...
                     <div>
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-sm font-bold text-white uppercase tracking-wider">People</h3>
                        ...
                        <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 gap-y-6 gap-x-2">
                             <div className="flex flex-col items-center gap-2 cursor-pointer group">
                                <div className="w-14 h-14 rounded-full bg-compass-bg border-2 border-dashed border-compass-muted/50 flex items-center justify-center text-compass-muted hover:border-compass-primary hover:text-white transition-all">
                                    <Icons.Plus />
                                </div>
                            ...
                            {contacts.map((name, i) => (
                                ...
                                >
                                    ...
                                    <span className="text-xs text-compass-muted group-hover:text-white truncate w-14 text-center">{name}</span>
                                </div>
                            ))}
                        </div>
                     </div>
                ...
                <div className="space-y-6">
                     ...
                     <div className="bg-compass-card rounded-3xl p-6 border border-compass-secondary/30 shadow-xl">
                          <div className="flex justify-between items-center mb-4">
                              <h3 className="text-lg font-bold text-white flex items-center gap-2"><Icons.Split /> Split Expense</h3>
                          ...
                          <div className="bg-compass-bg/50 rounded-xl p-4 mb-4">
                              <div className="flex justify-between items-center mb-2">
                                  <span className="text-sm text-white font-medium">Dinner at Nobu</span>
                                  <span className="text-sm text-compass-muted">Yesterday</span>
                              </div>
                              <div className="text-2xl font-bold text-white mb-4">$342.80</div>
        ...
        {renderTab === 'bills' && (
             <div className="space-y-8 max-w-4xl mx-auto">
                 {/* PAY BILLS GRID */}
                 <div>
                     <h3 className="text-lg font-bold text-white mb-4">Pay Bills</h3>
                         ...
                         {[
                             ...
                             { label: 'More', icon: <Icons.MoreVertical />, color: 'text-gray-400' },
                              ...
                              <div key={i} className="flex flex-col items-center gap-2 cursor-pointer group p-2 rounded-xl hover:bg-compass-secondary/30 transition-all">
                                   ...
                                   <span className="text-[10px] text-compass-muted group-hover:text-white font-medium">{item.label}</span>
                              </div>
                         ))}
                     </div>
                 </div>
                 ...
                 <div className="bg-compass-card rounded-3xl p-6 border border-compass-secondary/30 shadow-xl">
                      <h3 className="text-lg font-bold text-white mb-6">Upcoming Subscriptions</h3>
        ...
        {renderTab === 'rewards' && (
            <div className="max-w-4xl mx-auto">
                ...
                <h3 className="text-lg font-bold text-white mb-4">Your Scratch Cards</h3>
