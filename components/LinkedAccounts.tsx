  ...
  return (
    <div className="p-4 md:p-8 pt-6 h-full bg-compass-bg animate-fade-in">
        <div className="flex items-center mb-8">
            ...
            <h1 className="text-xl md:text-3xl font-bold text-white">Linked Accounts</h1>
        </div>
                    ...
                    <div key={account.id} className="bg-compass-card rounded-xl p-6 flex flex-col justify-between border border-transparent hover:border-compass-primary/30 transition-all group min-h-[160px]">
                        <div className="flex justify-between items-start mb-4">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <div className="text-white font-medium text-lg group-hover:text-compass-primary transition-colors">{account.name}</div>
                                    <div className="text-compass-muted text-sm">{account.type}</div>
                                </div>
                            </div>
                            <button className="text-compass-muted hover:text-white">
                                <Icons.MoreVertical />
                            </button>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex justify-between items-center border-t border-compass-secondary pt-4">
                                ...
                                <div className={`font-bold ${account.balance < 0 ? 'text-[#ef4444]' : 'text-white'}`}>
