...
import { Account, Goal, Insight } from './types';
...
export const Icons = {
  ...
  Bank: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 21h18"/><path d="M5 21v-7"/><path d="M19 21v-7"/><path d="M2 10h20"/><path d="M12 3 2 10h20Z"/><path d="M9 21v-8"/><path d="M15 21v-8"/></svg>
  ),
  Search: () => (
  ...
  Split: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 3h5v5"/><path d="M8 3H3v5"/><path d="M12 22v-8.3a4 4 0 0 0-1.172-2.872L3 3"/><path d="m15 9 6-6"/></svg>
  ),
  Phone: () => (
...
export const MOCK_ACCOUNTS: Account[] = [
  { id: '1', name: 'J.P. Morgan - Self-Directed', type: 'Investment', balance: 120500.00, lastUpdated: 'Updated 5m ago', status: 'active', accountNumber: '1234' },
  { id: '2', name: 'Chase - Total Checking', type: 'Checking', balance: 15250.75, lastUpdated: 'Action required', status: 'warning', accountNumber: '5678' },
  { id: '3', name: 'Bank of America', type: 'Savings', balance: 0, lastUpdated: 'Connection failed', status: 'error', accountNumber: '9012' },
  { id: '4', name: 'Chase - Sapphire Preferred', type: 'Credit Card', balance: -1200.50, lastUpdated: 'Syncing now...', status: 'syncing', accountNumber: '3456' },
];

export const MOCK_GOALS: Goal[] = [
  { id: '1', name: 'House Down Payment', targetAmount: 50000, currentAmount: 47500, targetDate: 'Dec 2028', style: 'Conservative' }
];

export const MOCK_INSIGHTS: Insight[] = [
  { id: '1', title: 'Your asset mix is solid', description: 'Your current asset allocation is aligned with 90% of expert recommendations for your risk profile.', type: 'success', actionLabel: 'Review My Mix' },
  { id: '2', title: "Your 'First Home' goal is slightly off-track", description: 'Based on current projections, you may fall short of your target. Let\'s get it back on course.', type: 'warning', actionLabel: 'Review Goal' },
  { id: '3', title: 'Tech sector trending up', description: 'Recent market shifts present a potential opportunity. See if it aligns with your long-term strategy.', type: 'info', actionLabel: 'Learn More' },
  { id: '4', title: 'What is Dollar-Cost Averaging?', description: 'Learn about this powerful investment strategy and see how it could benefit your portfolio.', type: 'education', actionLabel: 'Read Article' },
];